...
function express() {
 if (firingRate >= 7 && firingRate <= 10) {
  ...
  theMan.innerHTML = player2 + ": Too early to jubilate, soldier. Shoot faster.";

 } else if (firingRate >= 11 &&
  firingRate <= 14) {

  expressions.innerHTML = input.value + ": I'm on fire!!";
  theMan.innerHTML = player2 + ": Good! But you can shoot faster, soldier!";
  ...
  theMan.innerHTML = player2 + ": I warned you, soldier!";
