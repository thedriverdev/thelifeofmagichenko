...
let highScorer = localStorage.getItem("highScorer") || "The Man";
let currentHighScorer = localStorage.getItem("highScorer");
...
function updateScoreCount() {
 ...
 if (firingRate === 0) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 0);

 } else if (firingRate === 1) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 1);

 } else if (firingRate === 2) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 1);

 } else if (firingRate === 3) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 2);

 } else if (firingRate === 4) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 3);

 } else if (firingRate === 5) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 5);

 } else if (firingRate === 6) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 8);

 } else if (firingRate === 7) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 13);

 } else if (firingRate === 8) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 21);

 } else if (firingRate === 9) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 34);

 } else if (firingRate === 10) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 55);

 } else if (firingRate === 11) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 89);

 } else if (firingRate === 12) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 144);

 } else if (firingRate === 13) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 233);

 } else if (firingRate === 14) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 377);

 } else if (firingRate === 15) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 610);

 } else if (firingRate === 16) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 987);

 } else if (firingRate === 17) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 1597);

 } else if (firingRate === 18) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 2584);

 } else if (firingRate === 19) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 4181);

 } else if (firingRate === 20) {
  scoreCountDisplay.innerHTML = "Score: ₦" + (scoreCount += 6765);
...
trigger.addEventListener("click", updateScoreCount);
...
// Local Highscore
 if (scoreCount >= highScore) {
  ...
  localStorage.setItem("highScorer", input.value);
  highScoreDisplay.style.fontWeight = "bold";
  highScoreDisplay.style.color = "cornflowerblue";

 }

 if (scoreCount > worldHighScore) {

  worldHighScoreDisplay.innerHTML = "New World Highscore: " + input.value + " - ₦" + scoreCount;
  worldHighScoreDisplay.style.color = "red";
  worldHighScoreDisplay.style.fontWeight = "bold";

 }

}
trigger.addEventListener("click", updateHighScore);
